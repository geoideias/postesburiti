...
map.getView().fit([-5369252.372059, -593302.477461, -5367792.924017, -592551.160811], map.getSize());
...
map.on("rendercomplete", function(evt) {
    if (!attributionComplete) {
        ...
        qgis2webAttribution.innerHTML = '<a href="https://wa.me/5563999644565">Cabral Engenharia e Gestão Territorial</a> &middot; ';
        var olAttribution = document.createElement('li');
        olAttribution.innerHTML = '<a href="https://instagram.com/cabralengenhariaa">@cabralengenhariaa</a> &middot; ';
        var qgisAttribution = document.createElement('li');
        qgisAttribution.innerHTML = '<a href="mailto:matiascabral.eng@gmail.com">matiascabral.eng@gmail.com</a>';
